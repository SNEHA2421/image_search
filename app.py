...
from create_thumb_images import create_thumb_images
...
def image_retrieval():
    ...
    upload_path = os.path.join('static/upload_image','query.jpg')
    ...
    if request.method == 'POST':
        if request.form['submit'] == 'Upload':
            ...
            return render_template('searching.html', message="Searched finished, cost {:3f} seconds.".format(time.time() - start_time),
